...
contract SwapVerifier {
    ...
    uint256 constant Qmx  = 8414312246882030963519702144357285415238171685261412031857192431233023326477;
    uint256 constant Qmy  = 5973830410823363674576604154517351881448317577666696037046210286952756458502;
    uint256 constant Qlx  = 19736227531400639927282946556256139858494595472164040625681861865845036835885;
    uint256 constant Qly  = 8528848814874576551534732122418454804446401295381158798925857702998165074634;
    uint256 constant Qrx  = 4789917418384839588147096678775797479721655184963161272937756905132931337054;
    uint256 constant Qry  = 6749345485496138602752239272800116953297377673119735248159688952988553546982;
    uint256 constant Qox  = 12637945754439840747518710647738783636209078247368099268503224342557244674237;
    uint256 constant Qoy  = 9663805371610406632956745708743776428259482979940720290086677315094178512899;
    uint256 constant Qcx  = 16857259229674888682468225168256428439782439780425136778062922648833579639148;
    uint256 constant Qcy  = 20502727674336658572386660753710874400898147662862415884828447875461107486291;
    uint256 constant S1x  = 9213316496271956308032469079311782194734145808876337682083760967489548746124;
    uint256 constant S1y  = 10601067996818568923568806349693085919299989664890469659709743712599687230148;
    uint256 constant S2x  = 18097651597732469800717094339896322375843830328218934111593414781018271005097;
    uint256 constant S2y  = 16594094190669353277822703184842809216290162056860184297133535417246920113678;
    uint256 constant S3x  = 3088979422847483385859349270782801188527538844363582129238073066135960572122;
    uint256 constant S3y  = 11594314784490266812737570009602010596146400427555460796547417858929492199713;
    ...
    uint16 constant lastMem = 1120;

    function verifyProof(uint256[24] calldata _proof, uint256[10] calldata _pubSignals) public view returns (bool) {
        assembly {
            /////////
            ...
            function calculateChallenges(pMem, pPublic) {
                ...
                mstore(add(mIn, 832 ), calldataload(pA))
                mstore(add(mIn, 864 ), calldataload(add(pA, 32)))
                mstore(add(mIn, 896 ), calldataload(pB))
                mstore(add(mIn, 928 ), calldataload(add(pB, 32)))
                mstore(add(mIn, 960 ), calldataload(pC))
                mstore(add(mIn, 992 ), calldataload(add(pC, 32)))
                
                beta := mod(keccak256(mIn, 1024), q) 
